...
#pragma mark - improve touch
//replace UITableViewDelegate call from touch detector event within table cell
-(void)selectRowAtIndexPath:(NSIndexPath *)indexPath withTableView:(UITableView *)tableView
{
    //if index is the same return
